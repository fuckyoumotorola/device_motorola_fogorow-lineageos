...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := fogorow
...
# Kernel
BOARD_KERNEL_CMDLINE += androidboot.hab.product=fogorow
TARGET_KERNEL_CONFIG += vendor/ext_config/moto-holi-fogorow.config
